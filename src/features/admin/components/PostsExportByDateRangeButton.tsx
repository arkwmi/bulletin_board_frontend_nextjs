...
import { postsExportByDateRange } from '../api/postsExportByDateRange';

const PostsExportByDateRangeButton: React.FC = () => {
  ...
  const handleExport = async () => {
    try {
      ...
      await postsExportByDateRange(formattedStartDate, formattedEndDate);
    } catch (error) {
...
export default PostsExportByDateRangeButton;
